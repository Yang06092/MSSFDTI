...
def parameter_parser(name):
    ...
    parser.add_argument("--d-out-channels",
                        type=int,
                        default=708,
                        help="out-channels of cnn/the dim of drug output features. Default is 1094")

    parser.add_argument("--p-out-channels",
                        type=int,
                        default=1512,
                        help="out-channels of cnn/the dim of protein output features. Default is 1556.")

    parser.add_argument("--drug-number",
                        type=int,
                        default=708,
                        help="drug number. Default is 1094.")
    ...
    parser.add_argument("--protein-number",
                        type=int,
                        default=1512,
                        help="miRNA number. Default is 1556.")


    parser.add_argument("--view-d",
                        type=int,
                        default=6,
                        help="views number. Default is 6(5 datasets for drug sim)")

    parser.add_argument("--view-p",
                        type=int,
                        default=5,
                        help="views number. Default is 5(5 datasets for protein sim)")
